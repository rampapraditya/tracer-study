...
if (isset($_SESSION["subfolder"])) {
    $_SESSION["RF"]["subfolder"] = $_SESSION["subfolder"];
}
...
//$ses = isset($_SESSION["subfolder"]) ? $_SESSION["subfolder"] : null;
//$_SESSION["subfolder"] = "atika";
//echo $_SESSION["subfolder"];
//$ses = $_GET['ses'];
$config = array(
    ...
    */
    ...
    'base_url' => $_SESSION['tautan_utama'],
    ...
    |
    */
    'upload_dir' => '/media/'.$_SESSION["subfolder"].'/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../media/'.$_SESSION["subfolder"].'/',
    ...
    |
    */
    'thumbs_base_path' => '../../thumbs/'.$_SESSION["subfolder"].'/',
    ...
    |
    */
    'thumbs_upload_dir' => '/thumbs/'.$_SESSION["subfolder"].'/',
