<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>/brgknadmin/ajaxlist",
            ordering: false
        });
    });
    ...
    function add() {
        window.location.href = "<?php echo base_url(); ?>/brgknadmin/detil";
    }
    
    function ganti(id) {
        window.location.href = "<?php echo base_url(); ?>/brgknadmin/detil/"+id;
    }
    
    function hapus(id, nama) {
        if (confirm("Apakah anda yakin menghapus barang nomor " + nama + " ?")) {
            $.ajax({
                url: "<?php echo base_url(); ?>/brgknadmin/hapus/" + id,
                type: "POST",
                dataType: "JSON",
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Maintenance Data Barang Keluar</p>
