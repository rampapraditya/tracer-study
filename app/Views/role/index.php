<script type="text/javascript">
    ...
    $(document).ready(function () {
        table = $('#tb').DataTable({
            ajax: "<?php echo base_url(); ?>/role/ajaxlist",
            ordering: false
        });
    });
    ...
    function add() {
        ...
        $('.modal-title').text('Tambah divisi / role');
    }
    ...
    function save() {
        ...
        if (nama === '') {
            ...
            if (save_method === 'add') {
                ...
                url = "<?php echo base_url(); ?>/role/ajax_edit";
            }
